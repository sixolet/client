...
import (
	...
	versioned "github.com/knative/client/pkg/client/clientset/versioned"
	internalinterfaces "github.com/knative/client/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/knative/client/pkg/client/listers/client/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClientV1alpha1().Plugins(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClientV1alpha1().Plugins(namespace).Watch(options)
			},
		},
		&clientv1alpha1.Plugin{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pluginInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clientv1alpha1.Plugin{}, f.defaultInformer)
}
