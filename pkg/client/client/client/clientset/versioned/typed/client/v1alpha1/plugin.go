...
import (
	...
	scheme "github.com/knative/client/pkg/client/clientset/versioned/scheme"
...
type PluginInterface interface {
	...
	UpdateStatus(*v1alpha1.Plugin) (*v1alpha1.Plugin, error)
...
func newPlugins(c *ClientV1alpha1Client, namespace string) *plugins {
	return &plugins{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *plugins) UpdateStatus(plugin *v1alpha1.Plugin) (result *v1alpha1.Plugin, err error) {
	result = &v1alpha1.Plugin{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("plugins").
