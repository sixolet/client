...
// knative.dev/client/tools/generic-apigen --api v1beta1 --out generated.go --my-package knative.dev/client/pkg/serving/generic/v1beta1 --interface-package knative.dev/client/pkg/serving/generic
...
func (s V1beta1TrafficTargetSlice) Find(tag string, revisionname string, latestrevision *bool) (generic.TrafficTarget, bool) {
...
func (s V1beta1TrafficTargetSlice) Upsert(tag string, revisionname string, configurationname string, latestrevision *bool, percent int, url *apis.URL) generic.TrafficTarget {
	ins := servingv1beta1.TrafficTarget{tag, revisionname, configurationname, latestrevision, percent, url}
